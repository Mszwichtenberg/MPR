...
public class CorpTest {
    ...
    void setUp() {
        ...
        corp.addEmployee(new Employee("Zielinski", "zielinski@gmail.com", "Netflix", Department.manager,LocalDate.of(2025,1,1)));
    ...
    void addEmployeeShouldAddNewEmployee() {
        Employee employee=new Employee("Polak","polak@polak.com","PolakCorp",Department.manager,LocalDate.of(2025,1,1));
